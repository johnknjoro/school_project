...
class StudentsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            //     return view('pages.apps.user-management.students.columns._actions', compact('user'));
            // })
            ->setRowId('id');
    }
    ...
    {
        return $model->newQuery()->where('is_student', 1)->latest();
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(2)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/pages//apps/user-management/students/columns/_draw-scripts.js')) . "}");
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('student_no')->title('Student Number'),
